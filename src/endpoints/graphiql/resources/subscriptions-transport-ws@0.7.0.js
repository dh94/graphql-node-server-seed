...
Object.defineProperty(exports, "__esModule", { value: true });
var lodash_1 = __webpack_require__(15);
function addGraphQLSubscriptions(networkInterface, wsClient) {
    ...
    return lodash_1.assign(networkInterface, {
...
var _kinds = __webpack_require__(13);
...
var defaults_1 = __webpack_require__(2);
var message_types_1 = __webpack_require__(4);
...
var SubscriptionClient = (function () {
    ...
    SubscriptionClient.prototype.unsubscribeAll = function () {
        ...
        Object.keys(this.operations).forEach(function (subId) {
            _this.unsubscribe(parseInt(subId, 10));
        });
    };
    ...
    SubscriptionClient.prototype.tryReconnect = function () {
        ...
        if (!this.reconnecting) {
            Object.keys(this.operations).forEach(function (key) {
                _this.unsentMessagesQueue.push(_this.buildMessage(parseInt(key, 10), message_types_1.default.GQL_START, _this.operations[key].options));
            });
